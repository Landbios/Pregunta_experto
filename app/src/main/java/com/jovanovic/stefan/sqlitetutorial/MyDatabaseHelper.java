...
class MyDatabaseHelper extends SQLiteOpenHelper {
    ...
    private static final String TABLE_NAME = "my_countries";
    ...
    void addBook(String Country, String Capital){
    ...
    void updateData(String row_id, String Country, String Capital){
        SQLiteDatabase db = this.getWritableDatabase();
        ContentValues cv = new ContentValues();
        cv.put(COLUMN_COUNTRY, Country);
        cv.put(COLUMN_CAPITAL, Capital);
